...
var AutoBuildTemplate = {
	...
	1:	{
		...
		Update: function () {
			var charPickit = "Follower/sorceress-fire.xpac.nip";
			...
			if (RunewordManager.hasSkill(56)) {
				Config.AttackSkill = [-1, 56, 47, 56, 47, 42, -1];
				Config.LowManaSkill	= [-1, -1];
			} else if (RunewordManager.hasSkill(47)) {
			...
			var runewords = ["Insight", "Infinity", "Treachery", "Stealth", "Smoke", "Ancient's Pledge", "Spirit Shield", "Lore", "Spirit Sword"];
