...
var AutoBuildTemplate = {
	...
	1:	{
		...
		Update: function () {
			...
			if (AutoBuildHelper.hasSkill(120)) { // Meditation
				Config.AttackSkill 	= [-1, 112, 113, 112, 113, 101, 120];
				Config.LowManaSkill	= [112, 120];
			} else if (AutoBuildHelper.hasSkill(113)) { // Concentration
				Config.AttackSkill 	= [-1, 112, 113, 112, 113, 101, 113];
				Config.LowManaSkill	= [0, 113];
			} else if (AutoBuildHelper.hasSkill(112)) { // Blessed Hammer
				Config.AttackSkill 	= [-1, 112, 108, 112, 108, 101, 108];
				Config.LowManaSkill = [0, 108];
			} else if (AutoBuildHelper.hasSkill(108)) { // Blessed Aim
